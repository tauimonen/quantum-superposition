...
public class QuantumEntanglementAnalyzer {
    ...
    */
    ...
    public QuantumEntanglementAnalyzer(double i00, double i01, double i10, double i11)
    {
    ...
    public void performMeasurement()
    {
        ...
        else
        {
            ...
            System.out.print("After measurement, the photon angles are " + formatNumber(angle1) + " and "
                    + formatNumber(angle2));
            System.out.println(" and the photon state is " + formatNumber(p00) + " " + formatNumber(p01) + " "
                    + formatNumber(p10) + " " +formatNumber(p11));
        }
    }
